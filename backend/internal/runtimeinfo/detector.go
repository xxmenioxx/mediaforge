...
func DetectAndSave(db *gorm.DB) (models.RuntimeSnapshot, error) {
	...
	for _, name := range encoderCandidates {
		...
		snapshot.Encoders[name] = models.JSONMap{
			...
			"qsvIcqMain8": capability.QSVICQMain8, "qsvIcqMain10": capability.QSVICQMain10, "qsvLaIcqMain8": capability.QSVLAICQMain8, "qsvLaIcqMain10": capability.QSVLAICQMain10,
			...
			"qsvVbrExtBrcMain8":     capability.QSVVBRExtBRCMain8,
			"qsvVbrLookAheadMain8":  capability.QSVVBRLookAheadMain8,

			"qsvCbrExtBrcMain10":    capability.QSVCBRExtBRCMain10,
			"qsvCbrLookAheadMain10": capability.QSVCBRLookAheadMain10,
			"qsvCbrExtBrcMain8":     capability.QSVCBRExtBRCMain8,
			"qsvCbrLookAheadMain8":  capability.QSVCBRLookAheadMain8,

			"qsvAdaptiveIMain10": capability.QSVAdaptiveIMain10,
			"qsvAdaptiveBMain10": capability.QSVAdaptiveBMain10,
			"qsvAdaptiveIMain8":  capability.QSVAdaptiveIMain8,
			"qsvAdaptiveBMain8":  capability.QSVAdaptiveBMain8,

			"qsvVbrAdvancedMain10": capability.QSVVBRAdvancedMain10,
			"qsvVbrAdvancedMain8":  capability.QSVVBRAdvancedMain8,
